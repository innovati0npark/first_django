...
class QuestionModelTests(TestCase):
    ...
    def test_no_questions(self):
        ...
        self.assertContains(response, "No polls are available.")                #response로 No polls are available이 나오냐?
        self.assertQuerySetEqual(response.context["latest_question_list"], [])      #latest_question_list의 값이 없냐?
...
class QuestionResultsViewTests(TestCase):
    ...
    #     #asserIs는 가정한다는 것, ,왼쪽과 오른쪽이 같다. 같지 않으면 테스트 실패했다고 출력됨.
